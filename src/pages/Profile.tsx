...
const Profile = () => {
  ...
  const t = profile?.language === 'nl' ? {
    ...
    showLocationButton: 'Locatie-knop tonen (mobiel)',
    showLocationButtonDesc: 'Toon een knop rechtsonder op de kaart om je locatie handmatig te vernieuwen (alleen op mobiele apparaten)',
    ...
    showLocationButton: 'Show location button (mobile)',
    showLocationButtonDesc: 'Show a button at the bottom right of the map to manually refresh your location (mobile devices only)',
